(function () {
    ...
    angular.module('ariaNg').config(['$translateProvider', 'ariaNgConstants', function ($translateProvider, ariaNgConstants) {
        var defaultLanguageResource = {
            ...
            'format.bt-file-filter.bulk.scope': 'BT small-file filter',
            'format.bt-file-filter.bulk.analyzing': 'Checking filterable tasks…',
            'format.bt-file-filter.bulk.empty': 'No filterable tasks',
            'format.bt-file-filter.bulk.ready': '{{count}} tasks · {{files}} small files',
            'format.bt-file-filter.bulk.action': 'Start filtering',
            'format.bt-file-filter.bulk.confirm-title': 'Filter active BT downloads?',
            'format.bt-file-filter.bulk.confirm-text': 'Filter {{count}} tasks; exclude {{files}} selected files under {{threshold}} MB.\nSkip magnet metadata, paused, and waiting tasks; preserve manual exclusions.\nAttempt to restore selections on failure; aria2 may delete excluded files on completion.',
            ...
            'format.bt-file-filter.stage.bulk-inspecting': 'Checking task',
