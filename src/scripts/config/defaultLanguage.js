(function () {
    ...
    angular.module('ariaNg').config(['$translateProvider', 'ariaNgConstants', function ($translateProvider, ariaNgConstants) {
        var defaultLanguageResource = {
            ...
            'format.bt-file-filter.bulk.scope': 'Only active BT payload downloads; magnet metadata tasks are excluded',
            'format.bt-file-filter.bulk.analyzing': 'Analyzing active BT downloads…',
            'format.bt-file-filter.bulk.empty': 'No active BT payload files need filtering. A task stays unchanged when all its selected files are below the threshold',
            'format.bt-file-filter.bulk.ready': '{{count}} tasks · {{files}} selected small files',
            'format.bt-file-filter.bulk.action': 'Filter {{count}} tasks',
            'format.bt-file-filter.bulk.confirm-title': 'Filter active BT downloads?',
            'format.bt-file-filter.bulk.confirm-text': 'Exclude {{files}} selected files smaller than {{threshold}} MB from {{count}} active BT tasks. aria2 may delete newly excluded files when each BT download completes.',
            'format.bt-file-filter.bulk.running': 'Filtering tasks one at a time: {{processed}}/{{total}}',
            'format.bt-file-filter.bulk.complete': 'Finished: {{filtered}} filtered · {{skipped}} skipped · {{failed}} failed',
            ...
            'BT task pending file filter': 'BT task pending file filter',
            'format.bt-file-filter.badge': 'Filtering…',
            'format.bt-file-filter.stage.waiting-metadata': 'Waiting for metadata',
            'format.bt-file-filter.stage.waiting-files': 'Waiting for file list',
            'format.bt-file-filter.stage.applying-filter': 'Applying filter',
            'format.bt-file-filter.stage.restoring-full': 'Restoring full task',
            'format.bt-file-filter.stage.starting-filtered': 'Starting filtered task',
